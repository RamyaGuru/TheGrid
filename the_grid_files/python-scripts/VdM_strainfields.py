...
for s in [-1,1]:
    ...
    plt.figure()
    plt.pcolormesh(Xstrain, Zstrain, strainxx, vmin = -.27, vmax = 0.27, cmap = "Greys")
    plt.ylim([-1e-9, 1e-9])
    plt.xlabel('x')
    plt.ylabel('z')
    plt.title(r'$e_{xx}$')
    plt.colorbar()
    plt.figure()
    plt.pcolormesh(Xstrain, Zstrain, strainzz, vmin = -.27, vmax = 0.27, cmap = "Greys")
    plt.ylim([-1e-9, 1e-9])
    plt.xlabel('x')
    plt.ylabel('z')
    plt.title(r'$e_{zz}$')
    plt.colorbar()
    plt.figure()
    plt.pcolormesh(Xstrain, Zstrain, strainzx, vmin = -.27, vmax = 0.27, cmap = "Greys")
    plt.ylim([-1e-9, 1e-9])
    plt.xlabel('x')
    plt.ylabel('z')
    plt.title(r'$e_{zx}$')
